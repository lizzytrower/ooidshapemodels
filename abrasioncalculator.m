function [abrasionrate] = abrasioncalculator(thetain,rhoin,Rouse,Stokes)
%ABRASIONCALCULATOR Calculates radial abrasion rate for an ooid
%   This function calculates radial abrasion rate for an ooid as a function
%   of the ooid's size (defined in polar coordinates), Rouse number, and
%   Stokes threshold.
